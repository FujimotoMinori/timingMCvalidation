...
Bool_t MySelector::Process(Long64_t entry)
{
   ...
   for (int i=0; i<ntracks; i++) {
	   ...
	   hist_BLY_IsEdge->Fill(hitIsEdge[i]);             
	   hist_BLY_IsOverflow->Fill(hitIsOverflow[i]);         
	   hist_BLY_IsSplit->Fill(hitIsSplit[i]);            
	   hist_BLY_L1A->Fill(hitLVL1A[i]);               
	   hist_BLY_ToT->Fill(hitTOT[i]);                
	   hist_BLY_Charge->Fill();             
	   hist_BLY_dEdx->Fill();               
	   hist_BLY_HitSize->Fill();            
	   hist_BLY_HitSizePhi->Fill();         
	   hist_BLY_HitSizeZ->Fill();           
	   hist_BLY_unbiasedResidualX->Fill(); 
	   hist_BLY_unbiasedResidualY->Fill(); 
	   hist_BLY_Isolation10x2->Fill();     
	   hist_BLY_Isolation20x4->Fill();     
	   hist_BLY_numTotalClustersPerModule->Fill();
	   hist_BLY_numTotalPixelsPerModule->Fill(); 
